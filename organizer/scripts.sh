near call wagmeet-owner.$NEAR_ID add_event '{"metadata" : { "name" : "DAkjhSDASDHAS","description":"Web3 servers cant go down – they use Ethereum, a decentralized network of 1000s of computers as their backend", "symbol":"WEB3", "host":"","event_address":"","location" : "Delhi" } }' --accountId $NEAR_ID --gas=75000000000000
