...
near call mint-wag.testnet add_event '{"metadata" : { "name" : "Hello","description":"Web3 servers cant go down – they use Ethereum, a decentralized network of 1000s of computers as their backend", "symbol":"WEB3", "host":"","event_address":"123wsd.mint-wag.testnet","location" : "Delhi", "total_tickets":10, "is_deleted":false } }' --accountId mint-wag.testnet --amount 3 --gas=75000000000000
