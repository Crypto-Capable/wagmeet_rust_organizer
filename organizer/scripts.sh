near call wagmeet-owner.$NEAR_ID add_event '{"metadata" : { "name" : "JKSFHGJFS","description":"Web3 servers cant go down – they use Ethereum, a decentralized network of 1000s of computers as their backend", "symbol":"WEB3", "host":"","event_address":"","location" : "Delhi" } }' --accountId $NEAR_ID --gas=75000000000000
near call wagmeet.testnet add_event '{"metadata" : { "name" : "FJLDHSFD","description":"Web3 servers cant go down – they use Ethereum, a decentralized network of 1000s of computers as their backend", "symbol":"WEB3", "host":"","event_address":"","location" : "Delhi" } }' --accountId $NEAR_ID --gas=75000000000000
