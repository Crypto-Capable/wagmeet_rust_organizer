...
near call wagmeet-owner.meghaha101.testnet add_event '{"metadata" : { "name" : "1birthday","description":"Web3 servers cant go down – they use Ethereum, a decentralized network of 1000s of computers as their backend", "symbol":"WEB3", "host":"","event_address":"","location" : "Delhi" }, "total_tickets" : 200 }' --accountId meghaha101.testnet --gas=300000000000000

near call wagmeet-owner.meghaha101.testnet add_event '{"metadata" : { "name" : "11Newspapaer","description":"Web3 servers cant go down – they use Ethereum, a decentralized network of 1000s of computers as their backend", "symbol":"WEB3", "host":"","event_address":"","location" : "Delhi" }, "total_tickets" : 200 }' --accountId wagmeet-owner.meghaha101.testnet --gas=300000000000000
near call wagmeet-owner.meghaha101.testnet all_events --accountId meghaha101.testnet 
near call wagmeet-owner.meghaha101.testnet all_hosts --accountId meghaha101.testnet 
