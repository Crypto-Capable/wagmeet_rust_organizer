...
near call wagmeet101.meghaha.testnet nft_mint '{"contract_a" : "wagmeet101.meghaha.testnet", "contract_b" : "nft.meghaha.testnet" }' --accountId wagmeet101.meghaha.testnet